...
| COE | **C**ommencement **o**f **E**mployment | Diensteintritt |  |  |
| EC | **E**mployer **C**hange | Stellenwechsel |  |  |
| https://de.wikipedia.org/wiki/Einzahlungsschein_mit_Referenznummer[ESR] |  | Einzahlungsschein mit Referenznummer |  |  |
...
| TOE | **T**ermination **o**f **E**mployment | Dienstaustritt |  |  |
