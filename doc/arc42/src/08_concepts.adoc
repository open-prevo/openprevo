...
The insured person has no choice: only if no new retirement fund is available he can get a new one.
...
The new retirement fund is allowed to claim the FZL at the previous retirment fund.
...
When entering a new retirement fund the FZE may also be contacted to transfer the ATL.
...
.Datenbekanntgabe 
[quote, Berufliche Vorsorge Gesetz, 'https://www.admin.ch/opc/de/classified-compilation/19820152/index.html#a86a[Artikel 86a]']     
